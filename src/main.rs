        ...
        egui::SidePanel::left("side_panel").show(ctx, |ui|{
           // if ui.add_sized([400.0, 400.0], button.clicked()){
            ...
            ui.vertical(|ui|{
                ...
                let status_off = parse_config::parse_sound_bot();
                let texture = self.status_on.get_or_insert_with(||{
                        
                        
                    ui.ctx().load_texture(
                        "Status Off", 
                       egui::ColorImage::new([200 ,10 ], Color32::from_rgb( get_color_r_sound(),  get_color_g_sound(),  get_color_b_sound())) ,
                ...
                ui.horizontal(|ui|{
                    ...
                    let texture = self.status_on.get_or_insert_with(||{
                        let status = parse_config::parse_bit_bot();
                            ...
                            ui.ctx().load_texture(
                                "Status Off", 
                                egui::ColorImage::new([200 ,10 ], Color32::from_rgb( get_color_r_bits(),  get_color_g_bits(),  get_color_b_bits())) ,
                                egui::TextureFilter::Linear)
            ...
            ui.vertical(|ui|{
                ...
                ui.horizontal(|ui|{
                    ...
                    let mut texture = self.status_on.get_or_insert_with(||{
                 
                       
                            ui.ctx().load_texture(
                                "Status Off", 
                                egui::ColorImage::new([200 ,10 ], Color32::from_rgb( get_color_r_sub(),  get_color_g_sub(),  get_color_b_sub())) ,
                                egui::TextureFilter::Linear)
